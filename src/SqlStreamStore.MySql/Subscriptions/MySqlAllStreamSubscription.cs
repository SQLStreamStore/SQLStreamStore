namespace SqlStreamStore.Subscriptions
{
    ...
    internal class MySqlAllStreamSubscription : IAllStreamSubscription
    {
        public const int DefaultPageSize = 10;
        private static readonly ILog s_logger = LogProvider.GetLogger("SqlStreamStore.Subscriptions.MySqlAllStreamSubscription");
        ...
        public MySqlAllStreamSubscription(
        ...
        private async Task Initialize()
        {
            ...
            catch(MySqlException exception) when(exception.InnerException is ObjectDisposedException)
            {
                NotifySubscriptionDropped(SubscriptionDroppedReason.Disposed);
                throw;
            }
