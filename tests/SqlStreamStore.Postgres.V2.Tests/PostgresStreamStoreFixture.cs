namespace SqlStreamStore
{
    ...
    public class PostgresStreamStoreFixture : IStreamStoreFixture
    {
            ...
            Action onDispose)
        {
            ...
            _settings = new PostgresStreamStoreV2Settings(connectionString)
            {
                Schema = schema,
                GetUtcNow = () => GetUtcNow(),
        ...
        public PostgresStreamStoreV2 PostgresStreamStore { get; private set; }
        ...
        public async Task Prepare()
        {
            ...
            PostgresStreamStore = new PostgresStreamStoreV2(_settings);
