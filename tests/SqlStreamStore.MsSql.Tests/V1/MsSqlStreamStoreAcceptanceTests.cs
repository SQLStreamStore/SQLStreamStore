namespace SqlStreamStore.V1
{
    ...
    using Shouldly;
    using SqlStreamStore.V1.ScriptsV2;
    ...
    public class MsSqlStreamStoreAcceptanceTests : AcceptanceTests
    {
        ...
        public void Can_export_database_creation_script()
        {
            ...
            sqlScript.ShouldBe(new Scripts("custom_schema").CreateSchema);
        }
        ...
        public async Task Time_taken_to_append_and_read_large_message_with_prefetch()
        {
            ...
            await StreamStoreExtensions.AppendToStream(fixture.Store, streamId, ExpectedVersion.Any, newStreamMessage);
