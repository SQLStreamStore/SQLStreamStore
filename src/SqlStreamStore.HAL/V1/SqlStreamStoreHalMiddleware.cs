namespace SqlStreamStore.V1
{
    ...
    using SqlStreamStore.V1.AllStream;
    using SqlStreamStore.V1.AllStreamMessage;
    using SqlStreamStore.V1.Docs;
    using SqlStreamStore.V1.Index;
    using SqlStreamStore.V1.StreamBrowser;
